...
const stringa1 = a.slice(0,2);
const stringa2 = b.slice(-3);
const conc= stringa1+stringa2;
const maiuscolo= conc.toUpperCase();
console.log(maiuscolo);
}
stringhe("Maledette","Funzioni");
/* ESERCIZIO 2 (for)
...
*/
const arrayDaSommare=[20,50,100,40,3];
function somma(a){
...
/* ESERCIZIO 5 (reduce)
  Scrivi una funzione per sommare i numeri contenuti in un array
*/
const arrayDaSommare2=[20,50,100,40,4];
function somma2(a){
const somma1=arrayDaSommare2.reduce((primoNumero, restoDeiNumeri)=>primoNumero+restoDeiNumeri, a);
console.log(somma1)
}
somma2(0)
/* ESERCIZIO 6 (map)
...
movies.forEach(element=>{
  ...
  option.setAttribute('value', elemet.imdbID);
